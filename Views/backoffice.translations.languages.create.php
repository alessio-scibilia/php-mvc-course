<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xl-8 col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="/backoffice/translations/languages/add" method="post" enctype="multipart/form">
                        <div class="basic-form">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label"><?php echo $view_model->translations->get('form_nome_lingua'); ?>
                                    :</label>
                                <div class="col-sm-9">
                                    <input type="text" name="nome_lingua" class="form-control validate-1"
                                           id="nome_lingua"
                                           placeholder="English">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label"><?php echo $view_model->translations->get('form_abbreviazione_lingua'); ?>
                                    :</label>
                                <div class="col-sm-9">
                                    <input type="text" name="abbreviazione" class="form-control validate-1"
                                           id="abbreviazione_lingua"
                                           placeholder="EN">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label"><?php echo $view_model->translations->get('shortcode_lingua'); ?>
                                    :</label>
                                <div class="col-sm-9">
                                    <input type="text" name="shortcode_lingua" class="form-control validate-1"
                                           id="shortcode_lingua"
                                           placeholder="EN">
                                </div>
                            </div>
