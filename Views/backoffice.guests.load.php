<div class="container-fluid">
    <div class="row">
        <div class="col-12 d-flex align-items-center justify-content-start mb15">
            <h1><i class="fa fa-upload"></i> <?php echo $langs['carica_ospiti']; ?></h1>
        </div>

        <div class="col-xl-6">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"><?php echo $langs['seleziona_file']; ?></h4>
                </div>
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-10">
                                <a href="javascript:void()" class="btn btn-success" id="uploadGuestsDo"
                                   data-success="<?php echo $langs['ospiti_caricati']; ?>"
                                   data-failure="<?php echo $langs['errore_salvataggio']; ?>"
                                   data-function="uploadGuests"><?php echo $langs['carica']; ?></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"><?php echo $langs['scarica_modello']; ?></h4>
                </div>
                <div class="card-body">
                    <div class="basic-form">
                        <div class="form-group row">
                                ...
                                <div class="text-center">
                                    <a download="modello_ospiti.csv" href="modelli/modello_ospiti.csv"
                                       class="btn btn-primary" id="" data-function=""><i
                                                class="fa fa-file-o"></i> <?php echo $langs['scarica_csv']; ?>
                                    </a><br/><br/>
                                    <a download="modello_ospiti.xls" href="modelli/modello_ospiti.xls"
                                       class="btn btn-primary" id="" data-function=""><i
                                                class="fa fa-file-excel-o"></i> <?php echo $langs['scarica_excel']; ?>
                                    </a>
                                </div>
                            </div>
                        </div>
