<div class="container-fluid">
    <div class="row">
        <div class="col-12 d-flex align-items-center justify-content-start mb15">
            <a href="javascript:void()" id="gobacksearch" class="open-view-action-inside back-btn"><i
                        class="fa fa-angle-left"></i> <?php echo $view_model->translations->get('indietro'); ?> /</a>
            <h1><i class="fa fa-calendar"></i> <?php echo $view_model->translations->get('modifica_evento'); ?></h1>
        </div>
        <div class="col-xl-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    <?php if ($view_model->event['nome'] == $view_model->user->id || $view_model->user->level <= 2) {
                        ?>
                        <div class="basic-form">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <input type="hidden" value="<?php echo $view_model - event - id; ?>>"
                                           id="id_evento">
                                    ...
                                    <select class="selectpicker3" data-live-search="true" id="strutture_associate">
                                        ...
                                        <optgroup label="<?php echo $view_model->translations->get('hotel'); ?>">
                                            <?php
                                        ...
                                        <optgroup label="<?php echo $view_model->translations->get('strutture'); ?>">
                                            <?php
                                ...
                                <div class="form-group col-md-6">
                                    <input type="checkbox" id="recupera"
                                           value="1" <?php if ($eventInfo['recupera_struttura'] == 1) echo 'checked="checked"'; ?>> <?php echo $langs['recupera_da_struttura']; ?>
                                </div>
                                <div class="row"
                                     id="dati_struttura_evento" <?php if ($eventInfo['recupera_struttura'] == 1) echo 'style="display:none;"'; ?>>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" id="nome_struttura" class="form-control validate-1"
                                               ...
                                               value="<?php echo $eventInfo['nome_struttura']; ?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label><?php echo $langs['email']; ?></label>
                                        <input type="text" id="email" class="form-control validate-1"
                                               placeholder="mario@rossi.it" value="<?php echo $eventInfo['email']; ?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control validate-1" id="indirizzo"
                                               ...
                                               value="<?php echo $eventInfo['indirizzo']; ?>">
                                    ...
                                    <div id="preview">
                                        <div class="img-form-preview" id="ifp-prw-1">
                                            ...
                                            <img class="img-form-preview-item img-hotel"
                                                 src="<?php echo $eventInfo['img_evento']; ?>" height="200px">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" id="nome_evento" class="form-control validate-1"
                                           ...
                                           value="<?php echo $eventInfo['nome_evento']; ?>">
                                </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-12">
                                    <input type="checkbox" <?php if ($eventInfo['recupera_convenzione'] == 1) echo 'checked="checked"'; ?>
                                           class=""
                                           id="recupera_convenzione"> <?php echo $langs['recupera_convenzione']; ?>
                                </div>

                                <div id="rec-conv"
                                     class="form-group col-md-12" <?php if ($eventInfo['recupera_convenzione'] == 1) echo 'style="display:none;"'; ?>>
                ...
                <div align="left">
                    ...
                    <?php if ($eventInfo['created_by'] == $_SESSION['id_user'] || $_SESSION['level'] <= 2) { ?>
                        <input type="button" class="btn btn-success"
                               ...
                               data-failure="<?php echo $langs['errore_salvataggio']; ?>" id="updateEvento"
                               value="<?php echo $langs['aggiorna_evento']; ?>">
                    <?php } else {
                        ...
                        <?php } else { ?>
                            <input type="button" class="btn btn-success"
                                   data-success="<?php echo $langs['modifiche_salvate']; ?>"
                                   data-failure="<?php echo $langs['errore_salvataggio']; ?>" id="updateEventoSmall"
                                   value="<?php echo $langs['aggiorna_evento']; ?>">
                        <?php }
                    } ?>
                </div>
