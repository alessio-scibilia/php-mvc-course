        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card">
                ...
                foreach ($view_model->event as $event) { ?>
                    <div class="card-body">
                        <?php if ($event->nome_evento == $view_model->user->id || $view_model->user->level <= 2) {
                            ?>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="row"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" id="latitudine" class="form-control"
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="form-group col-md-12">
                <div align="left">
                    ...
                    <?php if ($event->created_by == $view_model->user->id || $view_model->user->id <= 2) { ?>
                        <input type="button" class="btn btn-success"
                               value="<?php echo $view_model->translations->get('aggiorna_evento'); ?>">
                    <?php } else {
                        if ($event->created_by == $view_model->user->id) { ?>
                            <input type="button" class="btn btn-success"
                                   value="<?php echo $view_model->translations->get('aggiorna_evento'); ?>">
                        <?php } else {
                            ?>
                            <input type="button" class="btn btn-success"
                                   id="updateEventoSmall"
                                   value="<?php echo $view_model->translations->get('aggiorna_evento'); ?>">
                        <?php }
                    } ?>
                </div>
