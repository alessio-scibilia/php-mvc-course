            ...
            <div class="tab-content" id="menu">
                    ...
                    <div class="tab-pane fade <?php if(strtolower($view_model->menu_active_btn) == 'administrators') echo 'active show'; else echo $view_model->menu_active_btn;?>" id="administrators">
                        <ul class="metismenu tab-nav-menu">
                            ...
                            <li>
                                ...
                                <ul aria-expanded="false">
                                    <li>
                                        <a href="javascript:void()" class="open-view-action" data-action="administrators" data-title="<?php echo $view_model->translations->get('amministratori').' | '.$view_model->translations->get('nome_sito');?>" data-params="false">
                                            <?php echo $view_model->translations->get('tutti_amministratori');?>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void()" class="open-view-action" data-action="administrators" data-title="<?php echo $view_model->translations->get('amministratori').' | '.$view_model->translations->get('nome_sito');?>" data-params="<?php echo $view_model->translations->get('nuovo_params');?>">
                    ...
                    <div class="tab-pane fade <?php if(strtolower($view_model->menu_active_btn) == 'facilities') echo 'active show'; else echo $view_model->menu_active_btn;?>" id="facilities">
                        <ul class="metismenu tab-nav-menu">
                            ...
                            <li class="mega-menu mega-menu-xl">
                                ...
                                <ul aria-expanded="false">
                                    <li>
                                        <a href="javascript:void()" class="open-view-action" data-action="facilities" data-params="false">
                                            <?php echo $view_model->translations->get('lista_strutture');?>
                                        </a>
                                    </li>
                                    <?php if($view_model->user->level <= 3) { ?>
                                        <li>
                                            <a href="javascript:void()" class="open-view-action" data-action="facilities" data-params="<?php echo $view_model->translations->get('nuovo_params');?>">
                            ...
                            <?php if($view_model->user->level <= 2) { ?>
                                <li class="mega-menu mega-menu-xl">
                                    ...
                                    <ul aria-expanded="false">
                                        <li>
                                            <a href="javascript:void()" class="open-view-action" data-action="facilities" data-params="<?php echo $view_model->translations->get('categorie');?>"><?php echo $view_model->translations->get('lista_categorie');?></a></li>
                                        <li><a href="javascript:void()" class="open-view-action" data-action="facilities" data-params="<?php echo $view_model->translations->get('param_nuova_categoria');?>"><?php echo $view_model->translations->get('nuova_categoria');?></a></li>
                                    </ul>
                                </li>
                            <?php } ?>
                        </ul>
                ...
                <div class="tab-pane fade <?php if(strtolower($view_model->menu_active_btn) == 'events') echo 'active show'; else echo $view_model->menu_active_btn;?>" id="events">
                    <ul class="metismenu tab-nav-menu">
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false">
                                <li><a href="javascript:void()" class="open-view-action" data-action="events" data-title="<?php echo $view_model->translations->get('eventi').' | '.$view_model->translations->get('nome_sito');?>"data-params="false"><?php echo $view_model->translations->get('tutti_eventi');?></a></li>
                                <li><a href="javascript:void()" class="open-view-action" data-action="events" data-title="<?php echo $view_model->translations->get('eventi').' | '.$view_model->translations->get('nome_sito');?>"data-params="<?php echo $view_model->translations->get('nuovo_params');?>"><?php echo $view_model->translations->get('crea_evento');?></a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="tab-pane fade <?php if(strtolower($view_model->menu_active_btn) == 'guests') echo 'active show'; else echo $view_model->menu_active_btn;?>" id="guests">
                        <ul class="metismenu tab-nav-menu">
                            ...
                            <li>
                                ...
                                <ul aria-expanded="false">
                                    <li><a href="javascript:void()" class="open-view-action" data-action="guests" data-title="<?php echo $view_model->translations->get('ospiti').' | '.$view_model->translations->get('nome_sito');?>" data-params="false"><?php echo $view_model->translations->get('tutti_ospiti');?></a></li>
                                    <li><a href="javascript:void()" class="open-view-action" data-action="guests" data-title="<?php echo $view_model->translations->get('ospiti').' | '.$view_model->translations->get('nome_sito');?>" data-params="<?php echo $view_model->translations->get('param_carica');?>"><?php echo $view_model->translations->get('carica_ospiti');?></a></li>
                                    <li><a href="javascript:void()" class="open-view-action" data-action="guests" data-title="<?php echo $view_model->translations->get('ospiti').' | '.$view_model->translations->get('nome_sito');?>" data-params="<?php echo $view_model->translations->get('nuovo_params');?>"><?php echo $view_model->translations->get('aggiungi_ospiti');?></a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="tab-pane fade <?php if(strtolower($view_model->menu_active_btn) == 'settings') echo 'active show'; else echo $view_model->menu_active_btn;?>" id="settings">
                    <ul class="metismenu tab-nav-menu">
                        ...
                        <li><a href="javascript:void()" class="open-view-action" data-action="settings" data-params="false"><?php echo $view_model->translations->get('impostazioni_account');?></a></li>
                    </ul>
                </div>
                ...
                <?php if($view_model->user->level <= 1) { ?>
                    <div class="tab-pane fade <?php if(strtolower($view_model->menu_active_btn) == 'translations') echo 'active show'; else echo $view_model->menu_active_btn;?>" id="translations">
                        <ul class="metismenu tab-nav-menu">
                            ...
                            <li><a class="open-view-action" data-action="translations" data-params="false" href="javascript:void()"><?php echo $view_model->translations->get('traduzioni');?></a></li>
                            ...
                            <li class="mega-menu mega-menu-xl">
                                ...
                                <ul aria-expanded="false">
                                    <li><a class="open-view-action" href="javascript:void()" data-params="<?php echo $view_model->translations->get('params_lingue');?>" data-action="translations"><?php echo $view_model->translations->get('lingue_create');?></a></li>
                                    <li><a class="open-view-action" href="javascript:void()" data-params="<?php echo $view_model->translations->get('params_nuova_lingua');?>" data-action="translations"><?php echo $view_model->translations->get('crea_nuova_lingua');?></a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
