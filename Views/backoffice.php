...
<!-- Content -->
<div id="main-wrapper" <?php include 'Views/xdebug.attribute.php'; ?>>
                        ...
                        <ul class="metismenu tab-nav-menu">
                            ...
                            <li class="mm-active">
                                ...
                                <ul aria-expanded="true">
                                    <li><a href="process/change_role?set=0<?php include 'Views/xdebug.querystring.php' ?>">Developer (God user)</a></li>
                        ...
                        <ul class="metismenu tab-nav-menu">
                            ...
                            <li>
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="javascript:void()" class="open-view-action"
