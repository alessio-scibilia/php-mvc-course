...
$id = $_POST['id'];
$cat_name = $_POST['nome_cat'];
if ($cat_name == '') {
    $query = "SELECT nome FROM categorie_strutture WHERE id = ?";
    $stmt = $dbh->prepare($query);
    $stmt->bindParam(1, $_POST['cat'], PDO::PARAM_INT);
    $stmt->execute();
    if ($stmt->rowCount() > 0) {
...
$dati_struttura = getDatiStruttura($dbh, $id);

$query = "SELECT * FROM strutture_hotel WHERE id_struttura = ? AND id_hotel = ? AND convenzionato = 1";
$stmt = $dbh->prepare($query);
$stmt->bindParam(1, $_POST['id'], PDO::PARAM_INT);
$stmt->bindParam(2, $_SESSION['id_hotel'], PDO::PARAM_INT);
$stmt->execute();
if ($stmt->rowCount() > 0)
    $is_conv = true;
else $is_conv = false;

//print_r($dati_struttura);
?>

<div class="mob-p20">
    <div class="d-flex d-flex-special">
        <svg xmlns="http://www.w3.org/2000/svg" width="39.195" height="38.203" viewBox="0 0 39.195 38.203"
             class="arrow-back-cat" data-id-cat="<?php echo $_POST['cat']; ?>">
        ...
        <div class="title-in-blue title-section pb0 pl40lg">
            <h3 class="title-in-blue-small" id="cat-names"><?php echo $cat_name; ?></h3>
            <h2 class="title-in-blue title-section title-less-mobile"
                id="nome-struttura"><?php echo $dati_struttura[0]['nome_struttura']; ?></h2>
        </div>
    </div>
    <div class="link-cat-item-container <?php if ($tab != 'item') echo 'dnmob'; ?>">
        <a href="javascript:void();" class="link-cat-item" data-section="1">
        ...
        <a href="javascript:void();" class="link-cat-item" data-section="2">
        ...
        <a href="javascript:void();" class="link-cat-item" data-section="3">
    ...
    <div class="padded">
        ...
        <div class="hidden-mob">
            <div class="p-desc-service">
                <?php echo $dati_struttura[0]['descrizione']; ?>
            </div>
            <?php
            if ($is_conv == true) { ?>
...
<style type="text/css">
    ...
    .st2 {
		...
		c0.5,0.5,0.6,1.3,0.1,1.8c-0.7,0.8-1.4,1.5-2.2,2.2C36.8,12.9,36.5,13,36.4,13.1z"/>
                    ...
                    <div><?php echo $dati_struttura[0]['descrizione_benefit']; ?></div>
        ...
        <div class="hidden-lg">
            <div class="owl-theme owl-carousel owl-item-cat-small">
                ...
                for ($i = 0; $i < sizeof($immagini) - 1; $i++) {
                    echo '<img src="cp/' . $immagini[$i] . '" class="cat-item-open cat-item-open-small">';
                } ?>
            </div>
            <div class="p-desc-service">
                <?php echo $dati_struttura[0]['descrizione']; ?>
...
<style type="text/css">
    ...
    .st2 {
		...
		c0.5,0.5,0.6,1.3,0.1,1.8c-0.7,0.8-1.4,1.5-2.2,2.2C36.8,12.9,36.5,13,36.4,13.1z"/>
                    ...
                    <p><?php echo $dati_struttura[0]['descrizione_benefit']; ?></p>
        ...
        $eccellenze = getDatiEccellenze($dbh, $id, $_SESSION['lang']);
        if (sizeof($eccellenze) > 0) { ?>
            <h2 class="title-in-blue mb60 title-in-page" id="da-provare"><?php echo $langs['da_non_perdere']; ?></h2>
            <div class="da-non-perdere">
                ...
                for ($i = 0; $i < sizeof($eccellenze); $i++) {
                    ...
                    <div class="item-cat-container-inside">
                        ...
                        <div class="info-cat-item info-cat-item-real">
        ...
        <?php } ?>
        <h2 class="title-in-blue title-in-page mb60" id="prenota"><?php echo $langs['info_e_prenotazioni']; ?></h2>
        ...
        <div class="info-item-container">
            <a class="info-item">
                ...
                <div onclick="openPrenota('item',<?php echo $dati_struttura[0]['id']; ?>,2);"
                     class="info-item-title"><?php echo $langs['scegli_data_prenota']; ?></div>
            </a>
            ...
            <?php } ?>
            <a class="info-item"
               href="https://www.google.it/maps/@<?php echo $dati_struttura[0]['latitudine']; ?>,<?php echo $dati_struttura[0]['longitudine']; ?>,8z"
               target="_blank">
                <div class="info-svg">
...
<div class="image_cat_item <?php if ($tab == 'item' && $section == 'booking') echo 'image_cat_item_active'; ?>">
