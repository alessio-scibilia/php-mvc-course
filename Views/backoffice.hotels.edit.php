<input type="hidden" id="hotel_id" value="<?php echo $id_hotel_query; ?>">
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12">
            <a href="https://wellcox.cluster031.hosting.ovh.net/index.php?strh=<?php echo $this_hotel['id']; ?>"
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="utente_abilitato" class="form-control">
                                    <option value="1" <?php if ($this_hotel['abilitato'] == 1) echo 'selected="selected"'; ?>>
                                        Si
                                    </option>
                                    <option value="0" <?php if ($this_hotel['abilitato'] == 0) echo 'selected="selected"'; ?>>
                                        No
                                    </option>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="utente-pro">
                                    <option value="3" <?php if ($this_hotel['livello'] == 3) echo 'selected="selected"'; ?>>
                                        Si
                                    </option>
                                    <option value="4" <?php if ($this_hotel['livello'] == 4) echo 'selected="selected"'; ?>>
                                        No
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="input-group col-md-12" id="preview-img-container">
                                <div id="preview">
                                    ...
                                    for ($i = 0; $i < sizeof($immagini) - 1; $i++) { ?>
                                        <div class="img-form-preview" id="ifp-prw-1"><span class="delete-preview"
                                                                                           id="prw-<?php echo $i; ?>"
                            ...
                            <div style="display: block;" class="form-service-container fsc-<?php echo $r; ?>"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        $lingue = getLangsShortcode($dbh);
                                        for ($i = 0; $i < sizeof($lingue); $i++) {
                                            $hotelLang = getDatiServizi($dbh, $id_hotel_query, $lingue[$i]['shortcode_lingua']);
                                            ?>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        $hotelLang = getDatiServizi($dbh, $id_hotel_query, $lingue[0]['shortcode_lingua']);
                                                ...
                                                <div class="input-time-container">
                                                            <span class="time-span">
                                                                <?php echo $langs['dalle']; ?> <input
                                                                        type="time" <?php if ($orari_sabato[0] == 1) echo 'disabled'; ?> class="validate-hotel"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <select id="abilitato-<?php echo $r; ?>" class="form-control">
                                            <option value="1" <?php if ($hotelLang[$r - 1]['abilitato'] == 1) echo 'selected="selected"'; ?>>
                                                Si
                                            </option>
                                            <option value="0" <?php if ($hotelLang[$r - 1]['abilitato'] == 0) echo 'selected="selected"'; ?>>
                                                No
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-5">
                                        ...
                                        for ($i = 0; $i < sizeof($lingue); $i++) {
                                            ...
                                            <textarea id="descrizione-<?php echo $lingue[$i]['shortcode_lingua']; ?>-1"
                                                      class="form-control descrizione_servizi descrizione_servizi-1 validate-hotel" <?php if ($i > 0) echo 'style="display:none;"'; ?>></textarea>
                                        <?php } ?>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label><?php echo $langs['immagine_servizio']; ?></label>
