<input ass="container-fluid">
    <div class="row">
        <form action="/backoffice/facilities/<?php  echo $view_model->principal->related_id; ?>/edit<?php include 'Views/xdebug.querystring.first.php'; ?>" method="post" enctype="multipart/form-data">
