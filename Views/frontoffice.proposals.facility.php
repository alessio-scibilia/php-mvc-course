<div class="mob-p20">
    <div class="d-flex d-flex-special">
        <svg xmlns="http://www.w3.org/2000/svg" width="39.195" height="38.203" viewBox="0 0 39.195 38.203"
             class="arrow-back-item-proposte">
        ...
        <div class="plat40 pl0mob">
            <h2 class="title-in-blue title-section title-less-mobile"
                id="titolo-proposta"><?php echo $dati_struttura[0]['nome_struttura']; ?></h2>
        </div>
    </div>
    <div class="padded">
        <div class="hidden-mob">
            <div class="p-desc-service">
                <?php echo $desc_struttura['descrizione']; ?>
            </div>
...
<style type="text/css">
    ...
    .st2 {
		...
		c0.5,0.5,0.6,1.3,0.1,1.8c-0.7,0.8-1.4,1.5-2.2,2.2C36.8,12.9,36.5,13,36.4,13.1z"/>
                ...
                <div><?php echo $desc_struttura['descrizione_benefit']; ?></div>
        ...
        <div class="data-container">
            ...
            <div class="travel-data-container">
                ...
                <div class="data-proposte-time">
                    <?php
                    if ($dati_struttura[0]['tipo_viaggio'] == 1) { ?>
                        <?php echo $time_travel; ?> <img src="img/walking.svg" alt="" title="">
                    <?php } else if ($dati_struttura[0]['tipo_viaggio'] == 2 || $dati_struttura[0]['tipo_viaggio'] == 0) { ?>
                        <?php echo $time_travel; ?> <img src="img/car.svg" alt="" title="">
                    <?php } else if ($dati_struttura[0]['tipo_viaggio'] == 3) { ?>
                        <?php echo $time_travel; ?> <img src="img/mezzi.svg" alt="" title="">
                    <?php } ?>
                </div>
            </div>
            ...
            <div class="actions-small hidden-lg-actions">
                ...
                <a class="info-evento"
                   ...
                   target="_blank">
                    ...
                    <div onclick="openPrenota('prop',<?php echo $dati_struttura[0]['id']; ?>,2);"
...
<div
    class="image_cat_item_proposte <?php if ($tab == 'item' && $section == 'prop_cat_item') echo 'image_cat_item_proposte_active'; ?>">
    <?php
    $immagini = explode("|", $dati_struttura[0]['immagine_didascalia']);
    echo '<img src="cp/' . $immagini[$dati_struttura[0]['immagine_principale'] - 1] . '" class="cat-item-open">'; ?>
</div>
<div>
