var MotaAdmin = function () {
    var e = $(window).width(), t = function () {
        jQuery("select").length > 0 && jQuery("select").map(function() {
            let val = jQuery(this).val();
            return val ? jQuery(this).selectpicker('val', val) : jQuery(this).selectpicker();
        })
    }, n = function () {
    ...
    return {
        init: function () {
            ...
            t(), n(), jQuery("#menu").length > 0 && $("#menu").metisMenu(), jQuery(".metismenu > .mm-active ").each(function () {
            ...
            }), jQuery(".deznav-scroll").length > 0 && new PerfectScrollbar(".deznav-scroll"), a(), function () {
                ...
                if (jQuery("#ShareProfit").length > 0) {
                    ...
                    new Chart(e, {
                        ...
                        options: {weight: 1, cutoutPercentage: 65, responsive: !0, maintainAspectRatio: !1}
                    })
                }
