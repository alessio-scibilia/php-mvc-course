...
class BackofficeSettingsController
{
    ...
    public function http_get(array &$params): IView
    {
        ...
        $view_model = new BackOfficeViewModel('backoffice.settings', $title, $languages, $translations);
        $view_model->user = $user;
        $view_model->menu_active_btn = 'settings';
