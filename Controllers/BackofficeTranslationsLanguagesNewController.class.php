...
class BackofficeTranslationsLanguagesNewController
{
    ...
    public function http_get(array &$params): IView
    {
        ...
        $view_model = new BackOfficeViewModel('backoffice.translations.languages.create', $title, $languages, $translations);
